                                        ...
                                        <div class="row justify-content-end p-2">
                                            <div class="col-lg-3 col-md-4 col-6">
                                                <div class="input-group">
                                                    <input type="text" name="search_text" onkeyup="Javascript:table_listing_records_filter();" class="form-control" style="height:34px;" placeholder="Search By Supplier Name / Mobile_number" aria-label="Search" aria-describedby="basic-addon2">
                                            ...
                                            <?php if($supplier_count > 0) { ?>
                                                ...
                                                <button class="btn btn-primary py-2 mx-2" style="font-size:12px; width:75px;" type="button" onclick="Javascript:PrintSupplier('');"> <i class="fa fa-print"></i> Print </button>
                                                <?php
                                            } ?> 
...
<script type="text/javascript">
    ...
    function PrintSupplier(from) {
        var search_text = ""; var url = ""; 
        search_text = jQuery('input[name="search_text"]').val();
        url = "reports/rpt_supplier_a4.php?search_text="+search_text+"&from="+from;
        window.open(url,'_blank');
    }
</script>