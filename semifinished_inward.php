<?php 
	$page_title = "Semifinished Inward";
                                        ...
                                        <div class="row justify-content-end p-2">
                                            ...
                                            */ ?>
                                            <div class="col-lg-2 col-md-3 col-6">
                                                <div class="form-group">
                                                    <div class="form-label-group in-border">
                                                        <select name="filter_godown_id" class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" onchange="Javascript:table_listing_records_filter();">
                                                                ...
                                                                if(!empty($godown_list)) {
                                                                    foreach($godown_list as $data) {
                                                                        if(!empty($data['godown_id']) && $data['godown_id'] != $GLOBALS['null_value']) {
                                                                            ?>
                                                                            <option value="<?php echo $data['godown_id']; ?>" <?php if(!empty($login_godown_id) && $login_godown_id == $data['godown_id']) { ?>selected<?php } ?>>
                                                                                <?php
...
<script>
    $(document).ready(function(){
        $("#semifinishedinward").addClass("active");
