...
<table id="tbl_customer_list" class="data-table table nowrap tablefont" style="margin:auto; display:none;">
    <thead class="thead-dark">
        <tr>
            <th style="text-align: center; width: 50px;">S.No</th>
            <th style="text-align: center; width: 500px;">Customer Name</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if(!empty($data['customer_name'])) {
                                $data['customer_name'] = html_entity_decode($obj->encode_decode('decrypt',$data['customer_name']));
