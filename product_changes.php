<?php
	...
	if(isset($_REQUEST['show_product_id'])) { 
        ...
        <form class="poppins pd-20" name="product_form" method="POST">
                            ...
                            <div class="input-group">
                                <div class="input-group-append" style="width:100%;">
                                    <select class="select2 select2-danger" name="product_tax" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                        ...
                                        <option value="0%" <?php if(!empty($product_tax) && $product_tax == "0%") { echo "selected"; } ?>>0%</option>
                                        <option value="5%" <?php if(!empty($product_tax) && $product_tax == "5%") { echo "selected"; } ?>>5%</option>
                                        <option value="12%" <?php if(!empty($product_tax) && $product_tax == "12%") { echo "selected"; } ?>>12%</option>
                                        <option value="18%" <?php if(!empty($product_tax) && $product_tax == "18%") { echo "selected"; } ?>>18%</option>
                                        <option value="28%" <?php if(!empty($product_tax) && $product_tax == "28%") { echo "selected"; } ?>>28%</option>
                                    </select>
            ...
            <div class="row justify-content-center p-3">
                        ...
                        <table class="table nowrap cursor smallfnt w-100 table-bordered product_stock_table">
                            <thead class="bg-dark smallfnt">
                                <tr style="white-space:pre;">
                                    ...
                                    <th class="<?php if(empty($subunit_need)) { ?>d-none<?php } ?>" id="subunit_need_fields_th">Case<br>Contains</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <button class="btn btn-danger " type="button" onClick="SaveModalContent(event,'product_form', 'product_changes.php', 'product.php');">Submit</button>
                </div>
            </div>
    ...
    if(isset($_POST['edit_id'])) {
        ...
        if(isset($_POST['hsn_code'])) {
            ...
            $hsn_code_error = $valid->valid_number($hsn_code, "Hsn Code", "0", "8");
