<?php
                ...
                <div class="col-lg-2 col-md-3 col-6 py-2">
                    <div class="form-group">
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md" style="pointer-events: none; background-color: #e9ecef;">
    ...
    if(isset($_POST['edit_id'])) {
        ...
        if(!empty($product_ids) && count($product_ids) > 0) {
            ...
            for($i = 0; $i < count($product_ids); $i++) {
                ...
                $individual_tax[] = array('godown_id' => $godown_id[$i],'product_id' => $product_ids[$i],'content' => $contents[$i],'quantity' => $quantity[$i]);
            }

            array_multisort(array_column($individual_tax, "godown_id"), SORT_ASC, array_column($individual_tax, "content"), SORT_ASC, array_column($individual_tax, "product_id"), SORT_ASC, $individual_tax);
        ...
        if(empty($valid_delivery_slip) && empty($product_error) && empty($delivery_slip_error) && empty($valid_stock) && empty($valid_stock)) {
    ...
    if(isset($_POST['page_number'])) {
        ...
        $total_records_list = $obj->getDeliverySlipList($from_date, $to_date, $customer_id, $search_text, $show_bill);
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    if(!empty($delivery_slip_actions)) {
                                        ?>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                    <?php
                                                        if(in_array("convert", $delivery_slip_actions)){
                                                            ?>
                                                            <li>
                                                                <a class="dropdown-item" href="Javascript:ShowConversion('<?php if(!empty($list['delivery_slip_id'])) { echo $list['delivery_slip_id']; } ?>', '<?php if(!empty($page_title)) { echo $page_title; } ?>');">Convert To Estimate</a>
                                                            </li>
                                                            <?php
                                                        }
                                                        ...
                                                        if(in_array("edit", $delivery_slip_actions)){
                                                            ?>
                                                            <li>
                                                                <a class="dropdown-item" href="Javascript:ShowModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '<?php if(!empty($list['delivery_slip_id'])) { echo $list['delivery_slip_id']; } ?>');">Edit</a>
                                                            </li>
                                                            <?php
                                                        }
                                                        ...
                                                        if(in_array("delete", $delivery_slip_actions)){
                                                            ?>
                                                            <li>
                                                                <a class="dropdown-item" href="Javascript:DeleteModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '<?php if(!empty($list['delivery_slip_id'])) { echo $list['delivery_slip_id']; } ?>');">Delete</a>
                                                            </li>
                                                            <?php
                                                        }
                                                    ?>
