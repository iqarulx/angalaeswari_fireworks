                ...
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-2 col-md-4 col-12">
                            <div class="form-group">
                                <div class="form-label-group in-border mb-0">
                                    <select name="party_type" class="select2 select2-danger smallfnt" data-dropdown-css-class="select2 select2-danger" style="width: 100%;"  onchange="Javascript:getVoucherPartyList(this.value);">
                        ...
                        <div class="col-lg-3 col-md-3 col-12 party_display">
                            <div class="form-group pb-2">
                                <div class="form-label-group in-border mb-0">
                                    <select name="party_id" class="select2 select2-danger smallfnt" data-dropdown-css-class="select2 select2-danger">
                                        <option value="">Select</option>
                                    </select>
...
<!-- 
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-2 col-md-3 col-12">
                            <button class="btn btn-success add_payment_button" style="font-size:12px;" type="button" onclick="Javascript:AddPaymentRow();" name="append_button">
                                Add To Bill
                            </button>
                        </div>
                    </div>
    ...
    if(isset($_POST['edit_id'])) {
        $voucher_date = ""; $voucher_date_error = ""; $party_id = ""; $party_id_error = "";
        ...
        if(!empty($party_type_error)){
            if(!empty($valid_voucher)) {
                $valid_voucher = $valid_voucher." ".$valid->error_display($form_name, "party_type", $party_type_error, 'select');
            }
            else {
                $valid_voucher = $valid->error_display($form_name, "party_type", $party_type_error, 'select');
            }
        }
        ...
        if(empty($valid_voucher) && empty($payment_error)) {
			...
			if(preg_match("/^\d+$/", $check_user_id_ip_address)) {
                ...
                if($party_type == '1'){
                    ...
                    $name_mobile_city = $obj->getTableColumnValue($GLOBALS['supplier_table'], 'supplier_id', $party_id, 'name_mobile_city');
                } elseif($party_type == '2'){
                ...
                if(empty($edit_id)) {	
					...
					$columns = array('created_date_time', 'creator', 'creator_name', 'voucher_id', 'voucher_number', 'voucher_date', 'party_id', 'party_name','party_type', 'narration', 'amount', 'payment_mode_id', 'payment_mode_name', 'bank_id', 'bank_name','total_amount', 'deleted','name_mobile_city');
					$values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$null_value."'", "'".$voucher_date."'", "'".$party_id."'", "'".$party_name."'", "'".$party_type."'", "'".$narration."'", "'".$amount."'", "'".$payment_mode_ids."'", "'".$payment_mode_names."'", "'".$bank_ids."'", "'".$bank_names."'", "'".$total_amount."'", "'0'","'".$name_mobile_city."'");
                ...
                if(!empty($balance) && $balance == 1) {
                    ...
                    $bill_id = $voucher_id; $bill_date = $voucher_date;
    ...
    if(isset($_POST['page_number'])) {
		...
		$total_records_list = $obj->getVoucherList($from_date, $to_date, $show_bill, $filter_party_id,$party_type);
                    ...
                    if(!empty($show_records_list)) {
                        foreach($show_records_list as $key => $list) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if(!empty($list['party_type'])) {
                                            $party_type = "";
                                            $party_type = $list['party_type'];
                                            if($party_type == "1"){
                                                $party_type = "Supplier";
                                            } elseif ($party_type == '2'){
                                                $party_type = "Agent";
