...
<?php }
    ...
    if(isset($_REQUEST['product_consumption_row_index'])) {
        ...
        <tr class="product_row" id="product_row<?php echo $product_row_index; ?>">
            ...
            <td class="text-center px-2 py-2">
                ...
                <input type="hidden" name="subunit_name[]" id="subunit_name_<?php echo $product_row_index;?>" value="<?php echo $subunit_name; ?>">
                <input type="hidden" name="unit_type[]" id="unit_type_<?php echo $product_row_index;?>" value="<?php echo $unit_type; ?>">
                <input type="hidden" name="consumption_content[]" id="consumption_content_<?php echo $product_row_index;?>" value="<?php if(!empty($consumption_content)) { echo $consumption_content; } else { echo $GLOBALS['null_value']; } ?>">
            </td>
    ...
    if(isset($_REQUEST['purchase_entry_row_index'])) {
        ...
        <tr class="purchase_product_row" id="purchase_product_row<?php echo $purchase_entry_row_index; ?>">
            ...
            <td class="text-center px-2 py-2">
                <input type="text" name="entry_content[]" id="entry_content_<?php echo $purchase_entry_row_index;?>" class="form-control shadow-none" value="<?php echo $content; ?>" onfocus="Javascript:KeyboardControls(this,'number',8,'');" onkeyup="Javascript:calcToalPurchaseProductAmount('<?php echo $purchase_entry_row_index;?>');">
            </td>
