<?php
            ...
            if(preg_match("/^\d+$/", $check_user_id_ip_address)) { 
                ...
                if(empty($edit_id)) {
                    if(empty($prev_account_number)) {						
                        ...
                        $columns = array('created_date_time', 'creator', 'creator_name', 'bank_id','account_name', 'account_number', 'bank_name', 'ifsc_code','account_type','bank_name_account_number','branch','payment_mode_id','opening_balance','opening_balance_type','deleted');
                        $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$account_name."'", "'".$account_number."'","'".$bank_name."'","'".$ifsc_code."'","'".$account_type."'","'".$bank_name_account_number."'","'".$branch."'","'".$payment_mode_ids."'","'".$opening_balance."'","'".$opening_balance_type."'","0");
    ...
    if(isset($_POST['page_number'])) {
        ...
        $total_records_list = $obj->getTableRecords($GLOBALS['bank_table'], '','','');
