<?php
    ...
    if(empty($product_id)) {
        if(!empty($total_records_list)) {
            ...
            $unit_name_array = []; $sub_unit_name_array = [];
            ...
            if(!empty($total_display)){
                $pdf->SetX(120);
                $pdf->Cell(80,8,$total_display,1,1,'R',0);
            } else {
                $pdf->SetX(120);
