<?php
    ...
    $pdf->Cell(17,4,'Date',0,1,'C',1);
    $pdf->SetX(20);
    $pdf->Cell(17,4,'Bill No',0,0,'C',1);
    $pdf->SetY($y);
    $pdf->SetX(37);
    $pdf->Cell(20,8,'Payment Type',1,0,'C',1);
    $pdf->Cell(20,8,'Party Type',1,0,'C',1);
    $pdf->Cell(33,8,'Party Name',1,0,'C',1);
    ...
    if (!empty($payment_list)) {
        ...
        foreach ($payment_list as $data) {
            ...
            if (!empty($data['party_id'])) {
                $party_type = $obj->getTableColumnValue($GLOBALS['payment_table'], 'party_id', $data['party_id'], 'party_type');
            }
            ...
            $y_array = array($date_y,$party_type_y,$party_y,$payment_y,$credit_y);
            $max_y = max($y_array);
            ...
            $pdf->SetX(20);
            $pdf->Cell(17,$max_y,'',1,0,'C');
            $pdf->SetX(37);
            $pdf->Cell(20,$max_y,'',1,0,'C');
            $pdf->SetX(57);
            $pdf->Cell(20,$max_y,'',1,0,'C');
            $pdf->SetX(77);
            $pdf->Cell(33,$max_y,'',1,0,'C');
            $pdf->SetX(110);
        ...
        $pdf->SetX(20);
        $pdf->Cell(17,255-$pdf->GetY(),'',1,0,'C',0);
        $pdf->SetX(37);
        $pdf->Cell(20,255-$pdf->GetY(),'',1,0,'C',0);
        $pdf->SetX(57);
        $pdf->Cell(20,255-$pdf->GetY(),'',1,0,'C',0);
        $pdf->SetX(77);
        $pdf->Cell(33,255-$pdf->GetY(),'',1,0,'C',0);
        $pdf->SetX(110);
