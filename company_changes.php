<?php
    ...
    if(isset($_REQUEST['show_company_id'])) { 
        ...
        $name = ""; $address = ""; $country = "India"; $state = "Tamil Nadu"; $district = ""; 
        $city = ""; $pincode = ""; $gst_number = ""; $mobile_number = ""; $logo = "";
        ...
        <form class="poppins pd-20 redirection_form" name="company_form" method="POST">
            ...
            <div class="row p-3 justify-content-center">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-12 py-2">
                            <div class="form-group">
                                <div class="form-label-group in-border">
                                    <input type="text" id="mobile_number" name="mobile_number" onfocus="Javascript:KeyboardControls(this,'mobile_number',10,'');" onkeyup="Javascript:InputBoxColor(this,'text');" value="<?php if(!empty($mobile_number)) { echo $mobile_number; } ?>" class="form-control shadow-none" placeholder="" required>
                ...
                <div class="col-lg-3 col-md-3 col-12">
                    ...
                    <div class="text-center smallfnt">(Image Size 1000 x 1000)</div>
    ...
    if(isset($_POST['company_name'])) {	
        ...
        $others_city = ""; $others_city_error = ""; $logo_name = array(); $logo = "";
            ...
            if(preg_match("/^\d+$/", $check_user_id_ip_address)) {
                ...
                if(!empty($address)) {
                    if(!empty($company_details)) {
                        $company_details = $company_details."$$$".str_replace("\r\n", "$$$", $address);
                    }
                ...
                if(!empty($gst_number)) {
                    if(!empty($company_details)) {
                        $company_details = $company_details."$$$ GST IN :".$gst_number;
                    }
                ...
                if(empty($edit_id)) {
                    if(empty($prev_company_id)) {
                        ...
                        $columns = array('created_date_time', 'creator', 'creator_name', 'company_id', 'name', 'lower_case_name', 'address', 'state', 'district', 'city', 'pincode', 'others_city', 'gst_number', 'mobile_number', 'company_details', 'logo', 'primary_company','deleted');

                        $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$name."'", "'".$lower_case_name."'", "'".$address."'", "'".$state."'", "'".$district."'", "'".$city."'", "'".$pincode."'","'".$others_city."'", "'".$gst_number."'", "'".$mobile_number."'", "'".$company_details."'", "'".$logo."'", "'".$primary_company."'", "'0'");
