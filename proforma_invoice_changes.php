                    ...
                    if(isset($other_charges_values[$i])) {
                        ...
                        if(!empty($other_charges_error)) {
                            if(!empty($proforma_invoice_error)) {
                                $proforma_invoice_error = $proforma_invoice_error."<br>".$other_charges_error;
                            } else {
                                $proforma_invoice_error = $other_charges_error;
                            }
                        } else {
                            if(strpos($other_charges_values[$i], '%') !== false) {
                        ...
                        $other_charges_error = $obj->encode_decode('decrypt', $other_charges_name) . " cannot be empty";
                        if(!empty($proforma_invoice_error)) {
                            $proforma_invoice_error = $proforma_invoice_error."<br>".$other_charges_error;
                        } else {
                            $proforma_invoice_error = $other_charges_error;
