<?php
    ...
    if(isset($_REQUEST['get_product_stock_limit'])) {
        ...
        if($unit_type == '2') {
            $limit = $obj->getCurrentStockSubUnit($tables, $godown_id, $magazine_id, $product_id, $case_contains);
        } else {
            $limit = $obj->getCurrentStockUnit($tables, $godown_id, $magazine_id, $product_id, $case_contains);
        }
        echo $limit;
