<?php 
    ...
    if(isset($_POST['name'])) {	
		...
		if(empty($valid_user)) {
            ...
            $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$name."'", "'".$mobile_number."'", "'".$name_mobile."'", "'".$login_id."'", "'".$lower_case_login_id."'", "'".$password."'", "'".$admin."'", "'".$type."'", "'".$null_value."'", "'".$null_value."'", "'".$null_value."'", "'0'");
...
<head>
    <meta charset="utf-8">
    <title>Dashboard | Angalaeswari Fireworks</title>
                ...
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <a href="index.php" class="d-inline-block auth-logo">
                             <h1 class="text-white">Angalaeswari Fireworks</h1>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign <?php if(!empty($users_count)) { ?>in<?php } else { ?>up<?php } ?> to continue to Angalaeswari Fireworks.</p>
                            </div>
                            <div class="p-2 mt-4">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-group mb-1">
                                                <div class="form-label-group in-border">
                                                    <input type="text" id="name" name="username" class="form-control shadow-none login_controls" placeholder="" required>
