    ...
    <form class="poppins pd-20 redirection_form" name="unit_form" method="POST">
        ...
        <div class="row justify-content-center p-3">
                            ...
                            <div class="input-group mb-1">
                                ...
                                <?php if(empty($show_unit_id)) { ?>
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="button" onclick="Javascript:addCreationDetails('unit', 15);"><i class="fa fa-plus"></i></button>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
            ...
            <div class="col-md-12 pt-3 text-center">
                <button class="btn btn-dark" type="button" onClick="Javascript:SaveModalContent(event,'unit_form', 'unit_changes.php', 'unit.php');">
                    Submit
                </button>
            </div>
        </div>
