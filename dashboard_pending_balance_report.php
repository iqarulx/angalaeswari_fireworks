                                ...
                                <div class="row justify-content-end p-2">   
                                        ...
                                        <div class="form-group pb-2">
                                            <div class="form-label-group in-border mb-0">
                                                ...
                                                <select class="select2 select2-danger" name="view_type[]" data-dropdown-css-class="select2-danger"
                                                    ...
                                                    <option value="1" <?php if(in_array("1", $view_type)) echo 'selected'; ?>>Agent</option>
                                                    <option value="2" <?php if(in_array("2", $view_type)) echo 'selected'; ?>>Supplier</option>
                                                    <option value="4" <?php if(in_array("4", $view_type)) echo 'selected'; ?>>Customer</option>
                                                </select>
                                    ...
                                    <?php
                                        if (is_array($view_type)) {
                                            $view_type_value = reset($view_type); // Get last element of array
                                        } else {
                                            $view_type_value = $view_type;
                                        }

                                        ?>

                                        <button class="btn btn-primary m-1" style="font-size:11px;" type="button" onclick="window.open('reports/rpt_pending_payment.php?filter_party_id=<?php echo $filter_party_id; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&view_type=<?php echo $view_type_value; ?>&is_download=','_blank')"> <i class="fa fa-print"></i> Print </button>
