<?php 
    ...
    if(isset($_SESSION[$GLOBALS['site_name_user_prefix'].'_user_id']) && !empty($_SESSION[$GLOBALS['site_name_user_prefix'].'_user_id'])) {
        if(!empty($GLOBALS['user_type']) && $GLOBALS['user_type'] != $GLOBALS['admin_user_type']) {
            ...
            $permission_module = $GLOBALS['payment_module'];
    ...
    if(!empty($company_list)){
        foreach($company_list as $data){
            ...
            if(!empty($data['address2']) && $data['address2'] != 'NULL'){
                                ...
                                <form name="payment_report_form" method="POST">
                                    <div class="row  px-2 my-3">
                                        ...
                                        if($filter_bill_type != "3"){ ?>
                                            <div class="col-lg-2 col-md-4 col-12" id="common_type">
                                                <div class="form-group">
                                                    <div class="form-label-group in-border mb-0">
...
<script type="text/javascript">
    ...
    function ExportToExcel(type, fn, dl) {
        ...
        // window.open("payment_report.php", "_self");
