...
<table id="tbl_supplier_list" class="data-table table nowrap tablefont" style="margin:auto; display:none;">
    <thead class="thead-dark">
        <tr>
            <th style="text-align: center; width: 50px;">S.No</th>
            <th style="text-align: center; width: 500px;">Supplier Name</th>
            <th style="text-align: center; width: 500px;">Mobile Number</th>
            <th style="text-align: center; width: 500px;"> GST Number</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if(!empty($data['supplier_name'])) {
                                $data['supplier_name'] = html_entity_decode($obj->encode_decode('decrypt',$data['supplier_name']));
